/*
    ...
    @auth caller
*/
ACTION zomfruithunt::regnewuser(const name &user) {
...
/*
    ...
    @auth caller
*/
ACTION zomfruithunt::upgradefarm(const name &user) {
    // check for caller auth
    require_auth(user);
...
/*
    ...
    @auth caller
*/
ACTION zomfruithunt::syncfarm(const name &user, const std::vector<farming_event> &events) {
    // check for caller auth
    require_auth(user);
