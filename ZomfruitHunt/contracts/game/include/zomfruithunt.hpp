...
CONTRACT zomfruithunt : public contract {
    // the name of the tokens contract account
    static constexpr eosio::name TOKEN_CONTRACT = name("zomfruitoken");
    // the main token for this game
    static constexpr eosio::symbol PLT_SYMBOL = symbol("ZHT", 6);
