...
cleos wallet import --private-key 5Ju3RhxeFixCbDxa5NX6KBT8pM4HfgYQC4xSL7wkyNi7WwEqZJq  # zomfruithunt account private key
cleos wallet import --private-key 5HruJk6FLz46psZmVzNutTQ3JnV6TFCtg11ECyANivJkkmPfmE4  # zomfruithunt account private key

cleos create account eosio zomfruithunt EOS5BCMqTkCVwXXZnNRNTB5HLs4X1Ze7CZ1p438isdxRFrKZxLnip # zomfruithunt account public key
cleos create account eosio zomfruitoken EOS7zshmzr63UWashb1hc4APthxSMeNFwRDB1uKdSuPLVUNS3jbnD # zomfruithunt account public key
...
cleos set account permission zomfruithunt active --add-code
...
cleos set contract zomfruitoken $PWD eosio.token.wasm eosio.token.abi -p zomfruitoken@active
...
cleos push action zomfruitoken create '[ "zomfruithunt", "1000000000000.000000 PLT" ]' -p zomfruitoken@active
